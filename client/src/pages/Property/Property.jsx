...
import {useMutation, useQuery} from 'react-query' // for getting the data of the proeprty id 
...
const Property = () => {
    ...
    const {userDetails:{bookings},setUserDetails} =useContext(UserContextDetail);
        ...
        <div className='flexCenter property-details'>
            ...
            <div className='flexColStart left'>
                <div className='flexStart head'>
                    ...
                    <span className='redText' style={{fontSize:'1.5rem'}}>
                        ${data?.price}
                    </span>
                    </div>
